...
test_fem_inf.out: test_fem_inf.o fem_inf.o dvr.o bspline.o fd.o bps.o pot.o scale.o mat.o viewerfunc.o
test_mat.out: test_mat.o mat.o viewerfunc.o
test_oce2.out: test_oce2.o oce2.o mat.o fem_inf.o dvr.o bspline.o fd.o bps.o pot.o scale.o mat.o angmoment.o viewerfunc.o
