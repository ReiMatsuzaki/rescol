...
test_oce1.out: test_oce1.o oce1.o mat.o fem_inf.o dvr.o bspline.o fd.o bps.o pot.o cscaling.o mat.o angmoment.o y1s.o viewerfunc.o eeps.o synthesize.o op.o
test_pot.out: test_pot.o pot.o viewerfunc.o
test_cscaling.out: test_cscaling.o cscaling.o
test_op.out: test_op.o op.o ${OBJ_FEM}
